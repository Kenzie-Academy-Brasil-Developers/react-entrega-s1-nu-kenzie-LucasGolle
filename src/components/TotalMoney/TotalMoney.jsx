...
const TotalMoney = ({listTransactions}) =>{
    ...
    const receive = listTransactions.filter(({type}) => type === "Entrada").reduce((a, {value}) => a + parseFloat(value), 0)

    const expense = listTransactions.filter(({type}) => type === "Despesa").reduce((a, {value}) => a + parseFloat(value), 0)
